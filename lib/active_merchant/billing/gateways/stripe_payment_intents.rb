  ...
  module Billing #:nodoc:
    ...
    class StripePaymentIntentsGateway < StripeGateway
      ...
      def add_stored_credentials(post, options = {})
        ...
        # Stripe PI accepts network_transaction_id and ds_transaction_id via mit field under card. It can be sent in nested under stored credentials OR as its own field (add_ntid handles when it is sent in on its own)
